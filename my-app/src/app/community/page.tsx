  ...
  const bookClubs = [
    {
      ...
      members: 1234,
      image: "/f.jpg?height=100&width=100",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      name: "Mystery Lovers",
      members: 2345,
      image: "/h.jpg?height=100&width=100",
    },
    {
      id: 4,
      name: "YA Book Club",
      members: 3456,
      image: "/a.webp?height=100&width=100",
    },
  ];
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              {bookClubs.map((club) => (
                <Card key={club.id}>
                  ...
                  <CardFooter>
                    <Button className="w-full bg-[#363634]">Join Club</Button>
                  </CardFooter>
                </Card>
              ))}
            </div>
        ...
        <div className="mt-12 text-center">
          ...
          <Button size="lg" className="bg-[#363634]">
